...
public class LdapSha256PasswordEncoder implements PasswordEncoder {
	...
	private static final int SHA_LENGTH = 32;
	private static final String SSHA_PREFIX = "{SSHA256}";
	...
	public LdapSha256PasswordEncoder() {
		this(KeyGenerators.secureRandom());
	}

	public LdapSha256PasswordEncoder(BytesKeyGenerator saltGenerator) {
